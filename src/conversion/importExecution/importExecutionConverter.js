...
var ImportExecutionConverter = /** @class */ (function () {
     ...
     */
    function ImportExecutionConverter(options, isCloudConverter) {
        this.isCloudConverter = isCloudConverter;
        this.options = options;
    }
    ImportExecutionConverter.prototype.toXrayJson = function (results) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        testConverter = new testConverter_1.TestConverter(this.options, this.isCloudConverter);
                        _a = {
                        ...
                        return [4 /*yield*/, testConverter.toXrayTests(results)];
                    case 1: return [2 /*return*/, (_a.tests = _b.sent(),
                            _a)];
                }
            });
        });
    };
    ImportExecutionConverter.prototype.getTextExecutionResultSummary = function (results) {
        var _a;
        ...
        return ((_a = this.options.jira.testExecutionIssueSummary) !== null && _a !== void 0 ? _a : "Execution Results [".concat(new Date(results.startedTestsAt).getTime(), "]"));
    };
    ImportExecutionConverter.prototype.getDescription = function (results) {
        var _a;
        ...
        return ((_a = this.options.jira.testExecutionIssueDescription) !== null && _a !== void 0 ? _a : (0, dedent_1.dedent)("\n                Cypress version: ".concat(results.cypressVersion, "\n                Browser: ").concat(results.browserName, " (").concat(results.browserVersion, ")\n            ")));
    };
    return ImportExecutionConverter;
}());
