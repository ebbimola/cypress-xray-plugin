...
exports.IMPORT = exports.importOptionalDependency = void 0;
 ...
 */
function importOptionalDependency(packageName) {
    return __awaiter(this, void 0, void 0, function () {
        var dependency;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, exports.IMPORT)(packageName)];
                case 1:
                    dependency = _a.sent();
                    logging_1.LOG.message(logging_1.Level.DEBUG, "Successfully imported optional dependency: ".concat(packageName));
 ...
 * @returns the package
 */
var IMPORT = function (packageName) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Promise.resolve("".concat(packageName)).then(function (s) { return require(s); })];
